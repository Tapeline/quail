...
public class StringFuncBack extends FuncType {

    public StringFuncBack() {
        super("back", Arrays.asList("str", "c"), null);
    }
    ...
    public QType run(Runtime runtime, List<QType> a) throws RuntimeStriker {
        ...
        try {
            AnsiStringBuilder ansiStringBuilder = new AnsiStringBuilder()
                    .backgroundColor24(((StringType) a.get(1)).value)
