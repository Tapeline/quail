...
import me.tapeline.quailj.runtime.builtins.intype_list.ListFuncAdd;
...
public class ContainerFuncContains extends FuncType {
    ...
    public QType run(Runtime runtime, List<QType> a) throws RuntimeStriker {
        ...
        return new BoolType(((ContainerType) a.get(0)).table.containsKey(((StringType) a.get(1)).value));
    }
