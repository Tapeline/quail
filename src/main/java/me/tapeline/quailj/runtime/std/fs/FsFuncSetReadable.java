...
public class FsFuncSetReadable extends QBuiltinFunc {

    public FsFuncSetReadable(Runtime runtime) {
        super(
                "setReadable",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args) {
        return QObject.Val(new File(args.get("path").toString()).setReadable(
