...
public class WindowFuncMouseAbsX extends QBuiltinFunc {

    public WindowFuncMouseAbsX(Runtime runtime) {
        super(
                "mouseAbsX",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args) throws RuntimeStriker {
        ...
        return QObject.Val(MouseInfo.getPointerInfo().getLocation().x);
    }
