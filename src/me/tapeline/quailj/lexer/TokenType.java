...
public enum TokenType {
    ...
    COMMA("COMMA", ","),
    TYPE("TYPE", "(func|string|bool|num|container|list|metacontainer|object|function|method|staticmethod|class|anonymous)[\\s\\W]"),
    ...
    public static final List<TokenType> tokenTypeList = Arrays.asList(
            ...
            TYPE, BLOCK, KEYWORD, BINARYOPERATOR, WORDBINARYOPERATOR, UNARYOPERATOR,
            WORDUNARYOPERATOR, EFFECT, INSTRUCTION, ID, LPAR, RPAR, LSPAR, RSPAR,
            LCPAR, RCPAR, COMMENT, WHITESPACE);
