...
/*
    ...
    public LegacyRuntime(Node rootNode, RuntimeConfig cfg, String code, AdvancedActionLogger aal) {
    ...
    public QType raiseException(String msg, int pos) {
        DirectInstructionType exception = new DirectInstructionType(RuntimeStrikerTypes.EXCEPTION);
    ...
    public QType NodeRunner_run(Node node) {
        ...
        if (node instanceof UnaryOperatorNode) {
            switch (((UnaryOperatorNode) node).operator.c) {
                ...
                case "return": {
                    DirectInstructionType di = new DirectInstructionType(RuntimeStrikerTypes.RETURN);
        ...
        if (node instanceof BinaryOperatorNode) {
            ...
            switch (((InstructionNode) node).operator.c) {
                ...
                case "continue": {
                    return new DirectInstructionType(RuntimeStrikerTypes.CONTINUE);
                }
                case "break": {
                    return new DirectInstructionType(RuntimeStrikerTypes.BREAK);
                }
                case "memory": {
                ...
                if (b > a) {
                    for (long i = a; i <= b; i++) {
                        ...
                        if (result instanceof DirectInstructionType) {
                            if (((DirectInstructionType) result).i.equals(RuntimeStrikerTypes.CONTINUE))
                                continue;
                            else if (((DirectInstructionType) result).i.equals(RuntimeStrikerTypes.BREAK))
                                break;
                            else
                                return result;
                        }
            ...
            if (result instanceof DirectInstructionType) {
                if (((DirectInstructionType) result).i.equals(RuntimeStrikerTypes.EXCEPTION)) {
